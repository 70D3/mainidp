    ...
    <div id="pdc-dashboard-wrapper">
        ...
        <div class="prem-stat-grid" style="grid-template-columns: repeat(5, 1fr);">
            ...
            <a href="{{ route('pdc_admin.progress_talent') }}" class="prem-stat clickable prem-stat-blue">
                <div class="prem-stat-icon si-blue"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"
                        fill="currentColor">
                        <path
                ...
                <div class="prem-stat-label">On Progress Talent</div>
            </a>
            <a href="{{ route('pdc_admin.finance_validation') }}" class="prem-stat clickable prem-stat-green">
                <div class="prem-stat-icon si-green"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                        fill="currentColor">
                        <path
