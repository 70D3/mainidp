    ...
    <div class="flex flex-col sm:flex-row items-center gap-4 mt-8 mb-6">
        ...
        <div class="relative w-full sm:w-56">
            <select id="live-status-filter"
                ...
                <option value="pending">On Review</option>
                                    ...
                                    <tr class="hover:bg-teal-50/50 transition duration-150">
                                        ...
                                        <td class="px-6 py-5 whitespace-nowrap" style="text-align:center; vertical-align:middle;">
                                            ...
                                            <div class="flex flex-col items-center justify-center gap-1.5">
                                                ...
                                                @if ($project->verifier)
                                                    <div class="inline-flex w-full items-center justify-center gap-1 bg-blue-50/70 border border-blue-100 rounded px-2 py-1"
                                                         style="max-width: fit-content;">
                                                        <svg xmlns="http://www.w3.org/2000/svg" class="h-3 w-3 text-blue-500 flex-shrink-0" viewBox="0 0 20 20" fill="currentColor">
                                                            <path fill-rule="evenodd" d="M10 9a3 3 0 100-6 3 3 0 000 6zm-7 9a7 7 0 1114 0H3z" clip-rule="evenodd" />
                                                        </svg>
                                                        <span class="text-[10px] text-blue-700 font-semibold truncate max-w-[120px]" title="{{ $project->verifier->nama }}">
                                                            {{ $project->verifier->nama }}
                                                        </span>
                                                    </div>
                                                @endif
                                            </div>
