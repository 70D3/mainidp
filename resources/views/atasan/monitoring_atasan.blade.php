<x-atasan.layout title="Monitoring – Individual Development Plan" :user="$user">
    <x-slot name="styles">
        <style>
            ...
            .pdc-custom-table th:last-child {
                border-right: none;
            }
            ...
            .pdc-custom-table td:last-child {
                border-right: none;
            }
    ...
    <div id="logbookDetailModal"
        ...
        <div class="bg-white rounded-[20px] shadow-2xl w-full max-w-[500px] p-7 transform scale-95 transition-transform duration-300 max-h-[90vh] overflow-y-auto"
            ...
            <div class="flex justify-between items-start mb-4 border-b border-gray-100 pb-4">
                ...
                <button onclick="closeLogbookDetailModal()"
                    class="text-gray-400 hover:text-gray-600 bg-gray-50 rounded-full p-2 hover:bg-gray-200 transition">
            ...
            <div class="mt-6 pt-4 border-t border-gray-100">
                <button onclick="closeLogbookDetailModal()"
                    class="w-full bg-[#f1f5f9] text-[#64748b] font-bold py-2.5 rounded-xl hover:bg-gray-200 transition-colors">Tutup</button>
            </div>
        </div>
    </div>
    <script>
